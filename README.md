...
- [ ] Построить график потребления памяти в `valgrind massif visualier` и включить скриншот в описание вашего `PR` (вместо этого анализировал по boutglay.com/massifjs/);
- [+] Написать тест, на то что программа укладывается в бюджет по памяти
(К сожалению возникли проблемы с speedscope.app и valgrind massif visualier в процессе установки, и я не смог с ними поработать)
