...
UPD: Потребление памяти за всё время выполнения программы не превышает 45 MB. Скрин в описании PR.

В целом - мне кажеться, тут основной буст как по перфомансу, так и по памяти, дал потоковый подход. Думаю, что важнее написать более оптимальный алгоритм, а дальнейшая оптимизация - это уже шлифовка полученного результата.

## Защита от регрессии производительности
Для защиты от потери достигнутого прогресса при дальнейших изменениях программы я добавил perfomance тесты, которые проверяют, что прогорамма выполниться за определённое время и сложность алгоритма останеться линейной при увеличении входных данных
