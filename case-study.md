...
Создала соотв. переменные заранее и сравниваю с ними.

Решила проверить на сэмпле на 300_000 строк.

До:
```
Total allocated: 155.18 MB (2560691 objects)
```

После:

```
Total allocated: 133.02 MB (2006807 objects)
```
