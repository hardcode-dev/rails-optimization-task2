...
- решил избавиться от создания лишних строк, убрал сплит и используя match
...
– ObjectSpace[:TOTAL] улучшилась 562_487 -> 452_841 за счет уменьшения :T_HASH 119390 -> 77085
...
Метрика ObjectSpace[:TOTAL] не изменилась
...
File.write('result.json', '1', mode: 'a')
Создает 3 объекта T_FILE и около 9 объектов T_HASH
