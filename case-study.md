...
<img src="screenshots/okay.jpg" width=50%>
...
<img src="screenshots/ruby_prof_graphviz.png" height=100px>
...
<img src="screenshots/horses.jpg" width=50%>
...
<img src="screenshots/misha_restart.png" width=50%>
Пришлось немного начать сначала.

Оказалось, проблема в том, что потребление памяти во время выполнения программы растет, потому что мы все-таки копим объект report, чтобы потом записать его в result.json.
