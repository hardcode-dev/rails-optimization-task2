...
RSpec.describe ReportProcessor, type: :service do
  ...
  describe '#call' do
    ...
    it 'equals result data' do
      service.call(input_file_name: 'spec/tmp/test_data.txt')
      expect(File.read('result.json').chomp).to eq(expected_work_result)
    end
  end
end
