...
describe 'Correctness' do
  before { create_files }
  describe '#work' do
    before { work(file_name: 'files/data.txt') }
    it 'creates correct result' do
      expect(appropriate_result(File.read('files/result.json'))).to be true
    end
  end
end
...
def appropriate_result(string_for_parsing)
  parsed_json = JSON.parse(string_for_parsing)
  parsed_json['usersStats'] == {"Leida Cira"=>{"sessionsCount"=>6, "totalTime"=>"455 min.", "longestSession"=>"118 min.", "browsers"=>"FIREFOX 12, INTERNET EXPLORER 28, INTERNET EXPLORER 28, INTERNET EXPLORER 35, SAFARI 29, SAFARI 39", "usedIE"=>true, "alwaysUsedChrome"=>false, "dates"=>["2017-09-27", "2017-03-28", "2017-02-27", "2016-10-23", "2016-09-15", "2016-09-01"]}, "Palmer Katrina"=>{"sessionsCount"=>5, "totalTime"=>"218 min.", "longestSession"=>"116 min.", "browsers"=>"CHROME 13, CHROME 6, FIREFOX 32, INTERNET EXPLORER 10, SAFARI 17", "usedIE"=>true, "alwaysUsedChrome"=>false, "dates"=>["2017-04-29", "2016-12-28", "2016-12-20", "2016-11-11", "2016-10-21"]}, "Gregory Santos"=>{"sessionsCount"=>4, "totalTime"=>"192 min.", "longestSession"=>"85 min.", "browsers"=>"CHROME 20, CHROME 35, FIREFOX 47, SAFARI 49", "usedIE"=>false, "alwaysUsedChrome"=>false, "dates"=>["2018-09-21", "2018-02-02", "2017-05-22", "2016-11-25"]}} &&
    parsed_json['totalUsers'] == 3 &&
    parsed_json['uniqueBrowsersCount'] == 14 &&
    parsed_json['totalSessions'] == 15 &&
    parsed_json['allBrowsers'] == "CHROME 13,CHROME 20,CHROME 35,CHROME 6,FIREFOX 12,FIREFOX 32,FIREFOX 47,INTERNET EXPLORER 10,INTERNET EXPLORER 28,INTERNET EXPLORER 35,SAFARI 17,SAFARI 29,SAFARI 39,SAFARI 49"
end
__END__
{
  "totalUsers":3,
  ...
  "usersStats":
  {
    "Leida Cira":
    {
      ...
      "usedIE":true,"alwaysUsedChrome":false,"dates":["2017-09-27","2017-03-28","2017-02-27","2016-10-23","2016-09-15","2016-09-01"]
    },
    "Palmer Katrina":
    {
      "sessionsCount":5,
